...
- design_score: оценка качества дизайна/презентации (0-10)
- technology_potential: оценка технологичности и современности (0-10)
...
- Будь конкретен и практичен в рекомендациях"""
        ...
        try:
            ...
            result = CompetitorAnalysis(
                ...
                technology_potential=data.get("technology_potential", 5)
            )
...
- design_score: оценка качества дизайна (0-10)
- technology_potential: оценка технологичности/современности (0-10)
- Каждый массив должен содержать 3-5 пунктов
- Пиши на русском языке
...
- design_score: оценка качества дизайна (0-10)
- technology_potential: оценка технологичности (0-10)
- Пиши на русском языке
